...
log using "log_05_final_hosp_${cdat}.log",  replace

*****************************************************
* Project Title: WHOLE Hospitalization            
* Author: Amy Chang  
* Senior Author: Abimereki Muzaale
* Collaborators: Indraneel Massie, Mary Grace Bowring
*****************************************************


**#Hospitalization (Abi) 20220712
clear all
use hosp_master, clear
